...
class ux_tx_indexedsearch extends tx_indexedsearch {
	...
	function makePointerSelector_link($str,$p,$freeIndexUid) {
		...
		if (is_string($linkObject)) {
			return $this->pointer_cObj->cObjGetSingle($linkObject, $linkConfig, 'ux_tx_indexedsearch.makePointerSelector_link');
		} else {
	...
	protected function init_pointer_cObj() {
		$this->pointer_cObj = t3lib_div::makeInstance('tslib_cObj');
